...
class FlightRadar24API(object):
    ...
    def get_flights(self, airline = None, bounds = None, airport = None, type = None):
        ...
        if type: request_params["type"] = type
        ...
        for flight_id, flight_info in response.items():
            ...
            if flight_id[0].isnumeric():
                ...
                #flights.append(flight_info[0],flight_info[1],flight_info[2],flight_info[3],flight_info[4],flight_info[5])
                #flights.append(flight_info[0])
